    ...
    <form method="POST" action="/admin/posts/<?= $post['id'] ?>" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="text" id="title" name="title" required 
                   value="<?= Security::escape($_POST['title'] ?? $post['title']) ?>"
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <textarea id="excerpt" name="excerpt" rows="3"
                      style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-md); font-size: 1rem;">
<?= Security::escape($_POST['excerpt'] ?? $post['excerpt']) ?></textarea>
        </div>
...
<?= Security::escape($_POST['content'] ?? $post['content']) ?></textarea>
